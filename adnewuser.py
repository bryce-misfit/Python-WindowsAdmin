"""
Description: 
Python script that will prompt for username, password, first name, last name, and email address.
...
Ensure that you have the necessary permissions to create new users in the specified Organizational Unit (OU) within Active Directory. 
